...
<body class="">
			...
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
						...
						<li class="nav-item">
					    <a href="/direction_centrale" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Direction centrale</span></a>
					</li>

						<li class="nav-item">
					    <a href="/distribution_epp" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Distribution epp</span></a>
					</li>
							<li class="nav-item">
					    <a href="/distribution_iepp" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Distribution iepp</span></a>
					</li>

						<li class="nav-item">
					    <a href="/drena" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Drena</span></a>
					</li>
                    <li class="nav-item">
					    <a href="/epp" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Epp</span></a>
					</li>

					 <li class="nav-item">
					    <a href="/besoin_iepp" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Expression besoin iepp</span></a>
					</li>
 <li class="nav-item">
					    <a href="/besoin_daf" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Expression besoin daf</span></a>
					</li>
 <li class="nav-item">
					    <a href="/besoin_drena" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Expression besoin drena</span></a>
					</li>
 <li class="nav-item">
					    <a href="/besoin_epp" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Expression besion epp</span></a>
					</li>
 <li class="nav-item">
					    <a href="/iepp" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Iepp</span></a>
					</li>
 <li class="nav-item">
					    <a href="/livraison_epp" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Livraison epp</span></a>
					</li>
 <li class="nav-item">
					    <a href="/livraison_iepp" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Livraison iepp</span></a>
					</li>
 <li class="nav-item">
					    <a href="/manuel_scolaire" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Manuels</span></a>
					</li>
 <li class="nav-item">
					    <a href="/niveau" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Niveau</span></a>
					</li>
 <li class="nav-item">
 ...
 <li class="nav-item">
					    <a href="/regulation_iepp" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Regulation iepp</span></a>
					</li>
 <li class="nav-item">


					    <a href="/retour_manuels" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Retour de manuels</span></a>
					</li>
 <li class="nav-item">
					    <a href="/role" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Role</span></a>
					</li>
 <li class="nav-item">
					    <a href="/type_manuel" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Type de manuels</span></a>
					</li>
 <li class="nav-item">
					    <a href="/compte_utilisateur" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Utilisateur</span></a>
					</li>
