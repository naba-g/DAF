...
@section('title', 'modification livraison en iepp')
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Modification livraison iepp</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/manuel_scolaire"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Administration</a></li>
                            <li class="breadcrumb-item"><a href="#!">Modification des livraison en IEPP</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>MODIFICATION LIVRAISON EN LIVRAISON IEPP </h5>
                    </div>
                    <div class="card-body">
