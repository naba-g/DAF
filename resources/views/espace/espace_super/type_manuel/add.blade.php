        ...
        @section('title', 'ajout type manuels')
        @section('content')
            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/type_manuel"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">GESTION DES TYPES DE MANUELS</a></li>
                            <li class="breadcrumb-item"><a href="#!">Création des type </a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>FORMULAIRE AJOUT TYPE DE MANUELS </h5>
                    </div>
                    <div class="card-body">
                        <form>
                             ...
                             <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="code_type" placeholder="saisir code">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="libelle_type" placeholder="saisir le libellé">
