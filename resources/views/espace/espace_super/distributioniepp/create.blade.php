        ...
        <div class="page-body">
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="niveau">Niveau scolaire <span class="text-danger">*</span></label>
                            ...
                            <small class="form-text text-muted">Niveaux enseignement primaire</small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Référence depuis table titreouvrage SIDMAS</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="quantite">Quantité d'ouvrages <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="quantite" name="quantite"
                                   min="1" max="50000" placeholder="Nombre d'exemplaires" required>
                            <small class="form-text text-muted">Nombre d'exemplaires à distribuer</small>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Titres d'ouvrages par type et niveau (exemples SIDMAS)
    ...
    typeOuvrageSelect.addEventListener('change', updateTitres);
