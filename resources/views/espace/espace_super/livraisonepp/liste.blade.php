...
@section('title', 'Liste des livraisons epp')
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Gestion des livraisons epp</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Administration</a></li>
                            <li class="breadcrumb-item"><a href="#!">La liste des livraisons epp</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <i class="feather icon-check"></i> Valider tous
                         </a>
                      </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-xs" role="group">
                                                ...
                                                <button type="button" class="btn btn-outline-success btn-action" title="valider" onclick="confirmDelete(1)">
